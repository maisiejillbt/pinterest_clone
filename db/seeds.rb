...
Board.create!(created_at: DateTime.now, name:"Dinner Ideas", description:"", user_id:user3.id, public:true) # 1,3
...
Pin.create!(created_at: DateTime.now, title:"San Diego Elopement", user_id:user6.id)
Pin.create!(created_at: DateTime.now, title:"I LOVE YOU A LATTE", user_id:user6.id)
Pin.create!(created_at: DateTime.now, title:"Spring Flowers for Wedding", user_id:user4.id)
Pin.create!(created_at: DateTime.now, title:"A COLOURFUL MODERN WEDDING", user_id:user25.id)
Pin.create!(created_at: DateTime.now, title:"Cova — Light + Ladder", user_id:user23.id)
Pin.create!(created_at: DateTime.now, title:"5 Floral Trends for 2021", user_id:user20.id)
Pin.create!(created_at: DateTime.now, title:"Water Bamboo Flower Arrangement", user_id:user21.id)
Pin.create!(created_at: DateTime.now, title:"Create Your Own Floral Arrangement", user_id:user19.id)
Pin.create!(created_at: DateTime.now, title:"Large Real Touch White Magnolia", user_id:user18.id)
Pin.create!(created_at: DateTime.now, title:"X-Large 60 White Tulips", user_id:user13.id)
Pin.create!(created_at: DateTime.now, title:"Amaranthus composition", user_id:user1.id)
Pin.create!(created_at: DateTime.now, title:"Farmhouse Style Floral", user_id:user1.id)
Pin.create!(created_at: DateTime.now, title:"Blooming Apricot & Blush Magnolia Branches", user_id:user1.id)
Pin.create!(created_at: DateTime.now, title:"Private Floral Arranging Class", user_id:user1.id)


Board.create!(description:"", created_at: DateTime.now, name:"DIY Home Decor", user_id:user3.id, public:true) 

Pin.create!(created_at: DateTime.now, title:"DIY Sofa Table Build", user_id:user12.id)
Pin.create!(created_at: DateTime.now, title:"How to make a giant standing mirror for $100", user_id:user21.id)
Pin.create!(created_at: DateTime.now, title:"Picture Ledge DIY", user_id:user18.id)
Pin.create!(created_at: DateTime.now, title:"DIY Patio Basket Lanterns", user_id:user15.id)
Pin.create!(created_at: DateTime.now, title:"DIY FAUX CERAMIC VASES", user_id:user2.id)
Pin.create!(created_at: DateTime.now, title:"DIY Wall Art with Wood Shims", user_id:user2.id)
Pin.create!(created_at: DateTime.now, title:"DIY RATTAN CABINET HACK WITH BURLAP", user_id:user6.id)
Pin.create!(created_at: DateTime.now, title:"The Index Wall Shelf in Oak", user_id:user6.id)
Pin.create!(created_at: DateTime.now, title:"DIY TV frame", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"Hidden Dresser Door", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"DIY Closet Makeover", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"DIY footed bowl", user_id:user3.id)


Board.create!(description:"", created_at: DateTime.now, name:"Autum Outfits", user_id:user3.id, public:true) 

Pin.create!(created_at: DateTime.now, title:"Parisian Chic", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"comfortable fall style", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"brown & black combo is so good", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"15 Outfits para verte chic", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"Dropped shoulder", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"Long Sleeve Lapel Loose Plaid", user_id:user5.id)
Pin.create!(created_at: DateTime.now, title:"Lorna luxe brown check", user_id:user5.id)
Pin.create!(created_at: DateTime.now, title:"Long Sleeve Button Down", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"Womens Turtleneck", user_id:user8.id)
Pin.create!(created_at: DateTime.now, title:"The Fall Trends You’re Probably Missing", user_id:user9.id)
Pin.create!(created_at: DateTime.now, title:"whatemwore on LTK", user_id:user9.id)


Board.create!(description:"", created_at: DateTime.now, name:"Christmas Decor Ideas", user_id:user3.id, public:true) 

Pin.create!(created_at: DateTime.now, title:"Christmas Tour - Home Bunch", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"Style Scouting: Vol. 24", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"35 Pretty Christmas Living", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"97 Farmhouse Christmas Decor", user_id:user3.id)
Pin.create!(created_at: DateTime.now, title:"Christmas Tree Ideas and Decor Trends for 2021", user_id:user10.id)
Pin.create!(created_at: DateTime.now, title:"CHRISTMAS TIRE ORNAMENTS", user_id:user10.id)
Pin.create!(created_at: DateTime.now, title:"Christmas Mantel", user_id:user19.id)
Pin.create!(created_at: DateTime.now, title:"Quick Christmas Table Centerpiece", user_id:user19.id)
Pin.create!(created_at: DateTime.now, title:"Woodland Christmas Home Tour", user_id:user19.id)
Pin.create!(created_at: DateTime.now, title:"Simple and Natural Christmas Decor", user_id:user10.id)
Pin.create!(created_at: DateTime.now, title:"Christmas Decor We Are Drooling Over", user_id:user19.id)
Pin.create!(created_at: DateTime.now, title:"Christmas Home Tour 2020", user_id:user19.id)


Board.create!(description:"", created_at: DateTime.now, name:"Engagement Rings", user_id:user1.id, public:true) 
...
Pin.create!(created_at: DateTime.now, title:"sage green collage kit", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"Matisse Print Green Leaf", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"Photo Wall Collage Kit", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"My Visit to the Real Monet's Garden in Giverny, France", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"fave green aesthetic <3", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"Abstract Faces Wallpaper Green / Gold Holden 12990", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"Aesthetics black and green", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"pastel green notebook", user_id:user10.id)
Pin.create!(created_at: DateTime.now, title:"Art Print: Green Butterfly Study, 19x13in.", user_id:user10.id)
Pin.create!(created_at: DateTime.now, title:"Fabric Forest Green and White", user_id:user10.id)
Pin.create!(created_at: DateTime.now, title:"Sage Green and White", user_id:user10.id)
Pin.create!(created_at: DateTime.now, title:"vintage indie poster pack", user_id:user10.id)
Pin.create!(created_at: DateTime.now, title:"green heart wallpaper", user_id:user10.id)
Pin.create!(created_at: DateTime.now, title:"Flowering Meadow, Dandelion", user_id:user9.id)


Board.create!(description:"", created_at: DateTime.now, name:"Hairstyles", user_id:user1.id, public:true) 

Pin.create!(created_at: DateTime.now, title:"Long Butterfly Locs", user_id:user9.id)
Pin.create!(created_at: DateTime.now, title:"Easy rubber band hairstyle", user_id:user9.id)
Pin.create!(created_at: DateTime.now, title:"Wand Curls Lace Front Wigs", user_id:user9.id)
Pin.create!(created_at: DateTime.now, title:"Sleek AF Braid & Edge", user_id:user9.id)
Pin.create!(created_at: DateTime.now, title:"Papaya Castor Scalp Massaging Serum", user_id:user9.id)
Pin.create!(created_at: DateTime.now, title:"11 Pretty Prom Hairstyles", user_id:user9.id)
Pin.create!(created_at: DateTime.now, title:"Back To School Hairstyles For Teens", user_id:user12.id)
...
Pin.create!(created_at: DateTime.now, title:"100 Insta Captions For Girls", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"Cool Snapchat Quotes & Captions", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"100 Instagram Captions", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"more captions✨", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"Cute and Aesthetic Instagram Captions", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"INSTAGRAM CAPTIONS", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"80 Sunset Captions For Instagram", user_id:user1.id)
Pin.create!(created_at: DateTime.now, title:"Best Instagram Captions", user_id:user20.id)
Pin.create!(created_at: DateTime.now, title:"Fall captions for instagram 2021", user_id:user20.id)
Pin.create!(created_at: DateTime.now, title:"50 + Instagram Caption Ideas | Birthdays, Selfies, Summer", user_id:user20.id)
Pin.create!(created_at: DateTime.now, title:"Quotes For Instagram Captions", user_id:user12.id)
Pin.create!(created_at: DateTime.now, title:"Savage Instagram Captions For Guys", user_id:user12.id)
Pin.create!(created_at: DateTime.now, title:"Instagram CAPTIONS FOR PICTURES", user_id:user12.id)
Pin.create!(created_at: DateTime.now, title:"Instagram Captions", user_id:user3.id)



Board.create!(description:"", created_at: DateTime.now, name:"Kawaii Wallpapers", user_id:user7.id, public:true) 

Pin.create!(created_at: DateTime.now, title:"CUTE", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"| 𝘩 𝘰 𝘮 𝘦 - template!", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"RantBook - 🌸1.//Je suis quelqu'un//🌸", user_id:user7.id)
Pin.create!(created_at: DateTime.now, title:"aube blue 오브블루 on Twitter", user_id:user13.id)
Pin.create!(created_at: DateTime.now, title:"@aube_blue NAVER", user_id:user13.id)
Pin.create!(created_at: DateTime.now, title:"life planner ･ﾟ✧ - template", user_id:user13.id)
Pin.create!(created_at: DateTime.now, title:"fondos de pantalla de anime", user_id:user13.id)
Pin.create!(created_at: DateTime.now, title:"Illustration lovely style", user_id:user10.id)
Pin.create!(created_at: DateTime.now, title:"マイメロ 待ち受け」の検索結果", user_id:user12.id)
Pin.create!(created_at: DateTime.now, title:"•~fondo kawaii para tu celular~•", user_id:user12.id)
Pin.create!(created_at: DateTime.now, title:"Free Lock Screen Wallpaper by Bymunbear", user_id:user12.id)
Pin.create!(created_at: DateTime.now, title:"💖✨", user_id:user20.id)


Board.create!(description:"", created_at: DateTime.now, name:"mEmeS", user_id:user7.id, public:true) 

Pin.create!(created_at: DateTime.now, title:"Funny relatable!", user_id:user2.id)
Pin.create!(created_at: DateTime.now, title:"yes <3", user_id:user2.id)
Pin.create!(created_at: DateTime.now, title:"Importantance of Friendship", user_id:user2.id)
Pin.create!(created_at: DateTime.now, title:"meme", user_id:user15.id)
Pin.create!(created_at: DateTime.now, title:"How I fix the WiFi", user_id:user15.id)
Pin.create!(created_at: DateTime.now, title:"Hilliorus Memes", user_id:user15.id)
Pin.create!(created_at: DateTime.now, title:"best bet to lose to", user_id:user17.id)
Pin.create!(created_at: DateTime.now, title:"74 Primo Marvel Memes & Posts", user_id:user17.id)
Pin.create!(created_at: DateTime.now, title:"21 Funny Loki Memes to Read When You've Got the Time", user_id:user17.id)
Pin.create!(created_at: DateTime.now, title:'The Dog Like "he has a point"', user_id:user17.id)
Pin.create!(created_at: DateTime.now, title:"I can’t this is too funny 😂", user_id:user17.id)
Pin.create!(created_at: DateTime.now, title:"I Mean... You Tried..?", user_id:user20.id)


Board.create!(description:"", created_at: DateTime.now, name:"Nail design inspo", user_id:user1.id, public:true) 

Pin.create!(created_at: DateTime.now, title:"PRETTY & CHIC NAIL TRENDS AND DESIGNS FOR FALL 2021", user_id:user8.id)
Pin.create!(created_at: DateTime.now, title:"Swirls", user_id:user8.id)
Pin.create!(created_at: DateTime.now, title:"Colorful retro flowers nail", user_id:user8.id)
Pin.create!(created_at: DateTime.now, title:"24Pcs Long Coffin False Nails", user_id:user8.id)
Pin.create!(created_at: DateTime.now, title:"Fun Nail Ideas", user_id:user8.id)
Pin.create!(created_at: DateTime.now, title:"Rings to match September fall nails in 2021", user_id:user8.id)
Pin.create!(created_at: DateTime.now, title:"French Tip Coffin", user_id:user19.id)
Pin.create!(created_at: DateTime.now, title:"29 Cute Short Gel Nails Designs & Ideas", user_id:user19.id)
Pin.create!(created_at: DateTime.now, title:"♡luna press on nails♡", user_id:user1.id)
Pin.create!(created_at: DateTime.now, title:"DIY Dip Powder Nails", user_id:user1.id)
Pin.create!(created_at: DateTime.now, title:"TRENDY NAIL DESIGNS FOR SPRING 2021", user_id:user1.id)
Pin.create!(created_at: DateTime.now, title:"The Best Nail Art Trends", user_id:user1.id)
Pin.create!(created_at: DateTime.now, title:"30+ Summer Floral Nail Designs", user_id:user1.id)
