...
Pin.create!(created_at: DateTime.now, title:"Plant shelf idea", user_id:20)
Pin.create!(created_at: DateTime.now, title:"20 Borderline Genius Ways To Spruce Up Your Bedroom", user_id:10)
Pin.create!(created_at: DateTime.now, title:"Boho Bedroom Decor Ideas", user_id:12)
Pin.create!(created_at: DateTime.now, title:"How To Design A Sustainable & Minimalist Holiday Home", user_id:5)
Pin.create!(created_at: DateTime.now, title:"10 Beautiful Screened in Porch Ideas", user_id:6)
Pin.create!(created_at: DateTime.now, title:"The New Neutrals", user_id:8)
Pin.create!(created_at: DateTime.now, title:"How to style bookshelves", user_id:7)
Pin.create!(created_at: DateTime.now, title:"How I Decorated My Entryway on a Budget", user_id:1)
Pin.create!(created_at: DateTime.now, title:"Modern Cottage Style Bedroom", user_id:1)
Pin.create!(created_at: DateTime.now, title:"Pantry Organization", user_id:1)
Pin.create!(created_at: DateTime.now, title:"Lookbook | Backsplash", user_id:1)
Pin.create!(created_at: DateTime.now, title:"Room Ideas", user_id:1)
