...
pin2.image.attach(io: File.open("Users/maisiebruno-tyne/Downloads/"), filename: "")
...
pin4.image.attach(io: File.open("Users/maisiebruno-tyne/Downloads/"), filename: "")
pin5 = Pin.create!(created_at: DateTime.now, title:"10 Beautiful Screened in Porch Ideas", user_id:6)
pin5.image.attach(io: File.open("Users/maisiebruno-tyne/Downloads/"), filename: "")
...
pin9.image.attach(io: File.open("Users/maisiebruno-tyne/Downloads/"), filename: "")
pin10 = Pin.create!(created_at: DateTime.now, title:"Pantry Organization", user_id:1)
pin10.image.attach(io: File.open("Users/maisiebruno-tyne/Downloads/"), filename: "")
pin11 = Pin.create!(created_at: DateTime.now, title:"Lookbook | Backsplash", user_id:1)
pin11.image.attach(io: File.open("Users/maisiebruno-tyne/Downloads/"), filename: "")
pin12 = Pin.create!(created_at: DateTime.now, title:"Room Ideas", user_id:1)
pin12.image.attach(io: File.open("Users/maisiebruno-tyne/Downloads/"), filename: "")
